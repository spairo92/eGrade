...
@WebServlet("/addProfessorServ")
public class addProfessorServ extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		if (requestType.equalsIgnoreCase("insert")) 
		{
			...
			try 
			{
			    ...
			    String insertStmt = "INSERT INTO PROFESSORS (Username, Name, Surname, Department) VALUES (";
			    insertStmt += "'" + username + "',";
			    insertStmt += "'" + name + "',";
			    insertStmt += "'" + surname + "',";
